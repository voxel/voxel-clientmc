...
(function() {
  ...
  ClientMC = (function() {
    ...
    ClientMC.prototype.enable = function() {
      var maxId, mcID, ourBlockID, ourBlockName, _i, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      ...
      if ((_ref2 = this.console) != null) {
        if ((_ref3 = _ref2.widget) != null) {
          _ref3.on('input', this.onConsoleInput = (function(_this) {
      ...
      for (mcID = _i = 0, _ref4 = this.translateBlockIDs.length; 0 <= _ref4 ? _i < _ref4 : _i > _ref4; mcID = 0 <= _ref4 ? ++_i : --_i) {
        this.translateBlockIDs[mcID] = this.registry.getBlockIndex(this.opts.mcBlocks["default"]);
      }
      _ref5 = this.opts.mcBlocks;
      for (mcID in _ref5) {
        ourBlockName = _ref5[mcID];
    ...
    ClientMC.prototype.nativeConsoleLog = function(args) {
      return Function.prototype.bind.call(console.log, console).apply(console, args);
    };

    ClientMC.prototype.log = function() {
      var msg, rest, _ref;
      msg = arguments[0], rest = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      this.nativeConsoleLog(['[voxel-clientmc] ' + msg].concat(rest));
      return (_ref = this.console) != null ? _ref.log(msg + ' ' + rest.join(' ')) : void 0;
    };
    ...
    ClientMC.prototype.onDecompressed = function(ev) {
      ...
      if (offset !== inflated.length) {
        return this.log("incomplete chunk decode: " + offset + " != " + inflated.length);
      }
    };

...
(function() {
  var ClientMC, decodePacket, ever, minecraft_protocol, onesInShort, tic, websocket_stream, webworkify;
  ...
  ClientMC = (function() {
    ...
    ClientMC.prototype.setupPositionUpdates = function() {
      ...
      return this.clearInterval = tic.interval(this.sendPositionUpdate.bind(this), 50);
    };

    ClientMC.prototype.sendPositionUpdate = function() {
      var pos, _ref;
      pos = (_ref = this.game.plugins) != null ? _ref.get('voxel-player').yaw : void 0;
      if (pos == null) {
        return;
      }
